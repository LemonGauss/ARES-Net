...
class ARES-Net():
    ...
    def __init__(self, ARES-Net_model, device, *, use_EPOC, EPOC_threshold=0.25, MLC_balance_factor=0.5, MCC_balance_factor=1.0):
        self.ARES-Net_model = ARES-Net_model
        self.ARES-Net_model.eval()
        self.device = device
    ...
    def semantic_seg(self, *, image, classnames, return_prob=False):
        ...
        for j in range(inputs.shape[0]):
            ...
            output = self.ARES-Net_model(image, inputs[j], l_mask=attentions[j])
    ...
    def referring_seg(self, *, image, sentence, return_prob=False):
        ...
        output = self.ARES-Net_model(image, inputs, l_mask=attentions)
